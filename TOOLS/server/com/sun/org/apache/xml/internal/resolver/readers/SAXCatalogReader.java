...
/*     */ 
/*     */   
/*  93 */   protected Hashtable namespaceMap = new Hashtable<Object, Object>();
/*     */ 
/*     */   
...
/* 232 */     BootstrapResolver bootstrapResolver = catalog.getCatalogManager().getBootstrapResolver();
/*     */     
...
/* 241 */         if (bootstrapResolver != null) {
/* 242 */           spHandler.setEntityResolver((EntityResolver)bootstrapResolver);
/*     */         }
/* 244 */         parser.parse(new InputSource(is), spHandler);
/*     */       } else {
/* 246 */         Parser parser = (Parser)Class.forName(this.parserClass).newInstance();
/* 247 */         parser.setDocumentHandler(this);
/* 248 */         if (bootstrapResolver != null) {
/* 249 */           parser.setEntityResolver((EntityResolver)bootstrapResolver);
/*     */         }
...
/*     */       
/*     */       try {
/* 351 */         this.saxParser = (SAXCatalogParser)Class.forName(saxParserClass).newInstance();
/*     */ 
/*     */         
...
/*     */       
/*     */       try {
/* 412 */         this.saxParser = (SAXCatalogParser)Class.forName(saxParserClass).newInstance();
/*     */ 
/*     */         
...
/* Location:              C:\Users\leo\Desktop\server.jar!\com\sun\org\apache\xml\internal\resolver\readers\SAXCatalogReader.class
