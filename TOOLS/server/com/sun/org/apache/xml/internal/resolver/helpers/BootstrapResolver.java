...
/*  66 */   private Hashtable publicMap = new Hashtable<Object, Object>();
/*     */ 
/*     */   
/*  69 */   private Hashtable systemMap = new Hashtable<Object, Object>();
/*     */ 
/*     */   
/*  72 */   private Hashtable uriMap = new Hashtable<Object, Object>();
/*     */ 
/*     */   
...
/*  98 */       resolved = (String)this.systemMap.get(systemId);
/*  99 */     } else if (publicId != null && this.publicMap.containsKey(publicId)) {
/* 100 */       resolved = (String)this.publicMap.get(publicId);
/*     */     } 
/*     */     
...
/* 147 */       result = (String)this.uriMap.get(href);
/*     */     }
/*     */     
/* 150 */     if (result == null) {
/*     */       try {
...
/* Location:              C:\Users\leo\Desktop\server.jar!\com\sun\org\apache\xml\internal\resolver\helpers\BootstrapResolver.class
