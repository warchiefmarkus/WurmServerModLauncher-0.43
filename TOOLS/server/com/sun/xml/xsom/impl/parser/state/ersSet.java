...
/*     */       
/*     */       case 0:
/* 128 */         revertToParentFromText(makeResult(), this._cookie, $value);
/*     */         break;
/*     */     } 
/*     */   }
/*     */ 
...
/* 145 */     if (this.v == null) return new Integer(this.$runtime.blockDefault);
/*     */     
/* 147 */     if (this.v.indexOf("#all") != -1) {
/* 148 */       return new Integer(7);
/*     */     }
/*     */     
/* 151 */     int r = 0;
/*     */     
/* 153 */     if (this.v.indexOf("extension") != -1) r |= 0x1; 
/* 154 */     if (this.v.indexOf("restriction") != -1) r |= 0x2; 
/* 155 */     if (this.v.indexOf("substitution") != -1) r |= 0x4;
/*     */     
/* 157 */     return new Integer(r);
/*     */   }
/*     */ }


/* Location:              C:\Users\leo\Desktop\server.jar!\com\sun\xml\xsom\impl\parser\state\ersSet.class
