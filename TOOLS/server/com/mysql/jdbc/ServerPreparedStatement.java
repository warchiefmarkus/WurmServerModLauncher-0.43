...
/*      */     
/*      */     try {
/*  355 */       return JDBC_4_SPS_CTOR.newInstance(new Object[] { conn, sql, catalog, Constants.integerValueOf(resultSetType), Constants.integerValueOf(resultSetConcurrency) });
/*      */     
/*      */     }
...
/*      */ 
/*      */     
/* 2720 */     this.hasCheckedRewrite = false;
/* 2721 */     this.canRewrite = false;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* 2795 */     long sizeOfEntireBatch = 10L;
/* 2796 */     long maxSizeOfParameterSet = 0L;
/*      */     
/* 2798 */     for (int i = 0; i < numBatchedArgs; i++) {
/* 2799 */       BindValue[] paramArg = ((BatchedBindValues)this.batchedArgs.get(i)).batchedParameterValues;
/*      */       
/* 2801 */       long sizeOfParameterSet = 0L;
/*      */       
/* 2803 */       sizeOfParameterSet += ((this.parameterCount + 7) / 8);
/*      */       
/* 2805 */       sizeOfParameterSet += (this.parameterCount * 2);
/*      */       
/* 2807 */       for (int j = 0; j < this.parameterBindings.length; j++) {
/* 2808 */         if (!(paramArg[j]).isNull) {
/*      */           
/* 2810 */           long size = paramArg[j].getBoundLength();
/*      */           
/* 2812 */           if ((paramArg[j]).isLongData) {
/* 2813 */             if (size != -1L) {
/* 2814 */               sizeOfParameterSet += size;
/*      */             }
/*      */           } else {
/* 2817 */             sizeOfParameterSet += size;
/*      */           } 
/*      */         } 
/*      */       } 
/*      */       
/* 2822 */       sizeOfEntireBatch += sizeOfParameterSet;
/*      */       
/* 2824 */       if (sizeOfParameterSet > maxSizeOfParameterSet) {
/* 2825 */         maxSizeOfParameterSet = sizeOfParameterSet;
/*      */       }
/*      */     } 
/*      */     
/* 2829 */     return new long[] { maxSizeOfParameterSet, sizeOfEntireBatch };
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/* 2835 */     BindValue[] paramArg = ((BatchedBindValues)paramSet).batchedParameterValues;
/*      */     
/* 2837 */     for (int j = 0; j < paramArg.length; j++) {
/* 2838 */       if ((paramArg[j]).isNull) {
/* 2839 */         batchedStatement.setNull(batchedParamIndex++, 0);
/*      */       }
/* 2841 */       else if ((paramArg[j]).isLongData) {
/* 2842 */         Object value = (paramArg[j]).value;
/*      */         
/* 2844 */         if (value instanceof InputStream) {
/* 2845 */           batchedStatement.setBinaryStream(batchedParamIndex++, (InputStream)value, (int)(paramArg[j]).bindLength);
/*      */         }
/*      */         else {
/*      */           
/* 2849 */           batchedStatement.setCharacterStream(batchedParamIndex++, (Reader)value, (int)(paramArg[j]).bindLength);
/*      */         } 
/*      */       } else {
/*      */         Object value;
/*      */ 
/*      */         
/* 2855 */         switch ((paramArg[j]).bufferType) {
/*      */           
/*      */           case 1:
/* 2858 */             batchedStatement.setByte(batchedParamIndex++, (paramArg[j]).byteBinding);
/*      */             break;
/*      */           
/*      */           case 2:
/* 2862 */             batchedStatement.setShort(batchedParamIndex++, (paramArg[j]).shortBinding);
/*      */             break;
/*      */           
/*      */           case 3:
/* 2866 */             batchedStatement.setInt(batchedParamIndex++, (paramArg[j]).intBinding);
/*      */             break;
/*      */           
/*      */           case 8:
/* 2870 */             batchedStatement.setLong(batchedParamIndex++, (paramArg[j]).longBinding);
/*      */             break;
/*      */           
/*      */           case 4:
/* 2874 */             batchedStatement.setFloat(batchedParamIndex++, (paramArg[j]).floatBinding);
/*      */             break;
/*      */           
/*      */           case 5:
/* 2878 */             batchedStatement.setDouble(batchedParamIndex++, (paramArg[j]).doubleBinding);
/*      */             break;
/*      */           
/*      */           case 11:
/* 2882 */             batchedStatement.setTime(batchedParamIndex++, (Time)(paramArg[j]).value);
/*      */             break;
/*      */           
/*      */           case 10:
/* 2886 */             batchedStatement.setDate(batchedParamIndex++, (Date)(paramArg[j]).value);
/*      */             break;
/*      */           
/*      */           case 7:
/*      */           case 12:
/* 2891 */             batchedStatement.setTimestamp(batchedParamIndex++, (Timestamp)(paramArg[j]).value);
/*      */             break;
/*      */           
/*      */           case 0:
/*      */           case 15:
...
/*      */           case 253:
/*      */           case 254:
/* 2899 */             value = (paramArg[j]).value;
/*      */             
/* 2901 */             if (value instanceof byte[]) {
/* 2902 */               batchedStatement.setBytes(batchedParamIndex, (byte[])value);
/*      */             } else {
/*      */               
/* 2905 */               batchedStatement.setString(batchedParamIndex, (String)value);
/*      */             } 
/*      */ 
/*      */ 
/*      */ 
/*      */             
/* 2911 */             if (batchedStatement instanceof ServerPreparedStatement) {
/* 2912 */               BindValue asBound = ((ServerPreparedStatement)batchedStatement).getBinding(batchedParamIndex, false);
/*      */ 
/*      */ 
/*      */               
/* 2916 */               asBound.bufferType = (paramArg[j]).bufferType;
/*      */             } 
/*      */             
/* 2919 */             batchedParamIndex++;
/*      */             break;
/*      */           
/*      */           default:
/* 2923 */             throw new IllegalArgumentException("Unknown type when re-binding parameter into batched statement for parameter index " + batchedParamIndex);
/*      */         } 
/*      */ 
/*      */ 
/*      */ 
...
/*      */       } 
/*      */     } 
/* 2931 */     return batchedParamIndex;
/*      */   }
/*      */   
/*      */   protected boolean containsOnDuplicateKeyUpdateInSQL() {
/* 2935 */     return this.hasOnDuplicateKeyUpdate;
/*      */   }
/*      */   
/*      */   protected PreparedStatement prepareBatchedInsertSQL(ConnectionImpl localConn, int numBatches) throws SQLException {
/*      */     try {
/* 2940 */       PreparedStatement pstmt = new ServerPreparedStatement(localConn, this.parseInfo.getSqlForBatch(numBatches), this.currentCatalog, this.resultSetConcurrency, this.resultSetType);
/* 2941 */       pstmt.setRetrieveGeneratedKeys(this.retrieveGeneratedKeys);
/*      */       
/* 2943 */       return pstmt;
/* 2944 */     } catch (UnsupportedEncodingException e) {
/* 2945 */       SQLException sqlEx = SQLError.createSQLException("Unable to prepare batch statement", "S1000", getExceptionInterceptor());
/* 2946 */       sqlEx.initCause(e);
/*      */       
/* 2948 */       throw sqlEx;
/*      */     } 
/*      */   }
...
/* Location:              C:\Users\leo\Desktop\server.jar!\com\mysql\jdbc\ServerPreparedStatement.class
