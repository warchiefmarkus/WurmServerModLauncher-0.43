...
/*     */   
/*     */   public WallOfFire() {
/*  51 */     super("Wall of Fire", 557, 10, 400, 10, 1, 0L);
/*  52 */     this.targetTileBorder = true;
/*  53 */     this.offensive = true;
/*  54 */     this.description = "creates a wall of fire on a tile border";
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 129 */       DbFence dbFence = new DbFence(StructureConstantsEnum.FENCE_MAGIC_FIRE, tilex, tiley, heightOffset, (float)(1.0D + power / 5.0D), dir, zone.getId(), layer);
/*     */       
/* 131 */       dbFence.setState(dbFence.getFinishState());
/* 132 */       dbFence.setQualityLevel((float)power);
/* 133 */       dbFence.improveOrigQualityLevel((float)power);
/* 134 */       zone.addFence((Fence)dbFence);
/* 135 */       performer.achievement(320);
/* 136 */       performer.getCommunicator().sendNormalServerMessage("You weave the source and create a wall.");
/* 137 */       Server.getInstance().broadCastAction(performer.getName() + " creates a wall.", performer, 5);
/*     */     }
/* 139 */     catch (NoSuchZoneException noSuchZoneException) {}
/*     */   }
/*     */ }


/* Location:              C:\Users\leo\Desktop\server.jar!\com\wurmonline\server\spells\WallOfFire.class
