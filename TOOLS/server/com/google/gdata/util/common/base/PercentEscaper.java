...
/*  86 */   private static final char[] URI_ESCAPED_SPACE = new char[] { '+' };
/*     */   
...
/* 143 */     for (char c1 : safeCharArray) {
/* 144 */       maxChar = Math.max(c1, maxChar);
/*     */     }
/* 146 */     boolean[] octets = new boolean[maxChar + 1]; int c;
/* 147 */     for (c = 48; c <= 57; c++) {
/* 148 */       octets[c] = true;
/*     */     }
/* 150 */     for (c = 65; c <= 90; c++) {
...
/* Location:              C:\Users\leo\Desktop\server.jar!\com\google\gdat\\util\common\base\PercentEscaper.class
