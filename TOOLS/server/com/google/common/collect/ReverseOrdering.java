...
/* 96 */     String str = String.valueOf(String.valueOf(this.forwardOrder)); return (new StringBuilder(10 + str.length())).append(str).append(".reverse()").toString();
/*    */   }
/*    */ }


/* Location:              C:\Users\leo\Desktop\server.jar!\com\google\common\collect\ReverseOrdering.class
