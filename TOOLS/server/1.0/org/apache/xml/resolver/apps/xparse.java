...
public class xparse {
  public static void main(String[] paramArrayOfString) throws FileNotFoundException, IOException {
    ...
    resolvingParser.setErrorHandler((ErrorHandler)xParseError);
...
/* Location:              C:\Users\leo\Desktop\server.jar!\1.0\org\apache\xml\resolver\apps\xparse.class
