...
/*  908 */     for (String element : SILENT_START) {
/*  909 */       if (value.startsWith(element)) {
/*  910 */         result = true;
/*      */         break;
/*      */       } 
/*      */     } 
...
/*      */       
/* 1016 */       for (String element : criteria) {
/* 1017 */         if (target.equals(element)) {
/* 1018 */           result = true;
/*      */           break;
/*      */         } 
/*      */       } 
...
/*      */   {
/* 1034 */     private final StringBuffer primary = new StringBuffer(DoubleMetaphone.this.getMaxCodeLen());
/* 1035 */     private final StringBuffer alternate = new StringBuffer(DoubleMetaphone.this.getMaxCodeLen());
...
/* Location:              C:\Users\leo\Desktop\server.jar!\org\apache\commons\codec\language\DoubleMetaphone.class
