...
/*    */ {
/* 33 */   private static final Logger log = Logger.getLogger(Playing.class.getName());
/*    */   
...
/*    */   
/*    */   public void onEntry() {
/* 40 */     log.fine("Setting transport state to PLAYING");
/* 41 */     getTransport().setTransportInfo(new TransportInfo(TransportState.PLAYING, 
/*    */ 
/*    */           
...
/* 49 */         getTransport().getInstanceId(), new EventedValue[] { (EventedValue)new AVTransportVariable.TransportState(TransportState.PLAYING), (EventedValue)new AVTransportVariable.CurrentTransportActions(
/*    */             
...
/* 64 */     return new TransportAction[] { TransportAction.Stop, TransportAction.Play, TransportAction.Pause, TransportAction.Next, TransportAction.Previous, TransportAction.Seek };
/*    */   }
/*    */   
...
/* Location:              C:\Users\leo\Desktop\server.jar!\org\fourthline\cling\support\avtransport\impl\state\Playing.class
